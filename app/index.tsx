  ...
  // }, [userToken]);
	...
	const handleLogin = async () => {
		if (!email || !password || (isSignUp && !confirmPassword)) {
			console.log(email, password, isSignUp, confirmPassword);
		...
		try {
			...
			if (error instanceof Error) {
				...
				Alert.alert("Authentication Failed", "An unkown error occurred.");
			}
		}
	};
	...
	const [request, response, promptAsync] = Google.useIdTokenAuthRequest({
		...
		scopes: ["email", "https://www.googleapis.com/auth/business.manage"],
	});
